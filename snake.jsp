<% if (request.getParameter("level") != null && request.getParameter("ini_len")
!= null) { int $level = 1; try { $level =
Integer.parseInt(request.getParameter("level")); } catch (Exception e) { } int
$ini_len = 0; try { $ini_len =
Integer.parseInt(request.getParameter("ini_len")); } catch (Exception e) { } if
($level < 0) { $level = 1; } if ($level > 10) { $level = 10; } if ($ini_len < 1)
{ $ini_len = 1; } if ($ini_len > 20) { $ini_len = 20; } %>
  ...
  <head>
    ...
    <script type="text/javascript">
      window.onload = function(){
          ...
          food.style.border = "2px solid #ffff";
          ...
          document.onkeydown = function(e){
              ...
              for(var i = 0; i < snake.length; i++){
                  ...
                  if(snake_elem == null){
                      ...
                      snake_elem.style.background = "#f00f";
